...
static char normbgcolor[]           = "#1a1515";
...
/* tagging */
static const char *tags[] = { "  ", "  ", " 󰨞 ", " 󰙯 ", " 󰙨 ", " 󱐋 " };
...
/* If you use amixer, use this instead. */
static const char *upvol[]      = { "/usr/bin/amixer",  "-c", "1",  "sset", "Master", "10+",    NULL };
static const char *downvol[]    = { "/usr/bin/amixer",  "-c", "1",  "sset", "Master", "10-",    NULL };
static const char *mutevol[]    = { "/usr/bin/amixerl", "-c", "1",  "sset", "Master", "toggle", NULL };

/* To use light add this to the constant definition section. */
static const char *light_up[]   = { "/usr/bin/light",   "-A", "5", NULL };
static const char *light_down[] = { "/usr/bin/light",   "-U", "5", NULL };

/* If you use scrot, use this instead. */ 
static const char *screen_shot_select[] = {"scrot", "-s", "%Y-%m-%d_$wx$h_scrot.png", "-e", "mv $f ~/Pictures/ScreenShots", NULL};
static const char *screen_shot[]        = {"scrot", "%Y-%m-%d_$wx$h_scrot.png", "-e", "mv $f ~/Pictures/ScreenShots", NULL};
